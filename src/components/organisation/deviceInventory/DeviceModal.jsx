  ...
  return (
    <div>
          ...
          <DialogContent className="sm:max-w-[525px]">
            ...
            <div>
              <Tabs defaultValue="staff" className="">
                ...
                >
                  <span className="font-poppins text-gray-600 text-[0.9rem]">
                    Click Next to continue setup for organization
                  </span>
      ...
      {isDocModalOpen && (
        ...
        >
          <DialogContent className="flex flex-col sm:max-w-[700px] items-center">
            ...
            <div className="flex items-center justify-center flex-col">
              <div className="flex flex-col gap-2">
                ...
                <DeviceModalDocs setUpId={setUpId} />
              </div>
            </div>
          </DialogContent>
        </Dialog>
