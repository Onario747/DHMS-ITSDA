...
const Hero = () => {
  return (
    <section className="max-container padding-x pt-[5rem] max-md:pt-[4rem] flex items-center justify-center flex-col">
      <h1 className="font-poppins tracking-wide max-md:tracking-normal text-[3.8rem] max-md:text-[2rem] max-sm:text-[1.5rem] font-bold text-center text-[#007BFF]">
      ...
      <p className="text-center py-2 font-montserrat font-medium max-md:text-[0.9rem] max-sm:text-[0.7rem]">
        Seamlessly Track, Optimize, and Protect All Your Devices <br className="max-sm:hidden" /> with
