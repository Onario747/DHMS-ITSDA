          ...
          if (row.status === "pending") {
            return (
              <div className="flex gap-2">
                <button
                  className="bg-green-500 text-white px-2 py-1 rounded-md font-poppins"
                  onClick={() =>
                    handleRequestMaintenance(row.setupId, "accept")
                  }
                >
                  Accept
                </button>
        ...
        if (status === "all" || status === "pending") {
          if (row.status === "pending") {
            return (
              <div className="flex gap-2">
                <button
                  className="bg-red-500 text-white px-2 py-1 rounded-md font-poppins"
                  onClick={() =>
                    handleRequestMaintenance(row.setupId, "decline")
                  }
                >
                  Decline
                </button>
